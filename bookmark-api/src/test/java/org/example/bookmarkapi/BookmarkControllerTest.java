...
import org.example.bookmarkapi.domain.BookmarkRepository;
...
// ----------------------------------------------------------------------------------
    ...
    void shouldGetBookmarks(int pageNo, int totalElements, int totalPages, int currentPage,
        ...
        mvc.perform(get("/api/bookmarks?page=" + pageNo))
                ...
                .andExpect(jsonPath("$.first", CoreMatchers.equalTo(isFirst)))
                .andExpect(jsonPath("$.last", CoreMatchers.equalTo(isLast)))
